...
enum Config {
	...
	TWODFXSIZE = 10000, // 1210 on PS2

	MAXVEHICLESLOADED = 50, // 70 on mobile

	NUMOBJECTINFO = 250, // object.dat

	// Pool sizes
	NUMPTRNODES = 90000,  // 26000 on PS2
	NUMENTRYINFOS = 30000, // 3200 on PS2
	NUMPEDS = 140,        // 90 on PS2
	NUMVEHICLES = 110,    // 70 on PS2
	NUMBUILDINGS = 100000, // 4915 on PS2
	NUMTREADABLES = 2214,
	NUMOBJECTS = 10000,
	NUMDUMMIES = 30000, // 2368 on PS2
	...
	NUMRADARBLIPS = 32,
	NUMGENERALPICKUPS = 700,
	NUMSCRIPTEDPICKUPS = 700,
